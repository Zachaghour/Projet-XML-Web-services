 ...
 * 
 */
@WebServiceClient(name = "ReleveWS", targetNamespace = "http://ws.zakaria.com/", wsdlLocation = "http://localhost:9191?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVEWS_QNAME = new QName("http://ws.zakaria.com/", "ReleveWS");
    ...
    public ReleveService getReleveServicePort() {
        return super.getPort(new QName("http://ws.zakaria.com/", "ReleveServicePort"), ReleveService.class);
    }
    ...
    public ReleveService getReleveServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.zakaria.com/", "ReleveServicePort"), ReleveService.class, features);
    }
