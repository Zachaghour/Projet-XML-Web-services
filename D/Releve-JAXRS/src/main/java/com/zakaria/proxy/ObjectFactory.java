 ...
 * generated in the com.zakaria.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetReleve_QNAME = new QName("http://ws.zakaria.com/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://ws.zakaria.com/", "getReleveResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zakaria.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.zakaria.com/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.zakaria.com/", name = "getReleveResponse")
